# Copilot Instructions — `invoices-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/invoices-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/invoices-microservice.git`, branch `main`.
